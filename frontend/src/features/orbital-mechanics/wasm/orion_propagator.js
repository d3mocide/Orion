/* @ts-self-types="./orion_propagator.d.ts" */

/**
 * Return the number of successfully loaded catalog entries.
 * @returns {number}
 */
export function catalog_size() {
    const ret = wasm.catalog_size();
    return ret >>> 0;
}

/**
 * Return metadata for one satellite by NORAD ID string. Returns null if not found.
 * @param {string} norad_id
 * @returns {any}
 */
export function get_metadata(norad_id) {
    const ptr0 = passStringToWasm0(norad_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @param {string} omm_json
 * @returns {any}
 */
export function load_catalog(omm_json) {
    const ptr0 = passStringToWasm0(omm_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_catalog(ptr0, len0);
    return ret;
}
 ...
 */
export function propagate_at_jd(jd_utc) {
    const ret = wasm.propagate_at_jd(jd_utc);
    return ret;
}
 ...
 * @returns {Float64Array}
 */
export function propagate_range(norad_id, jd_start, jd_end, step_sec) {
    const ptr0 = passStringToWasm0(norad_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.propagate_range(ptr0, len0, jd_start, jd_end, step_sec);
    return ret;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./orion_propagator_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('orion_propagator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
